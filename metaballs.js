...
const presets = {
  ...
  holographic: {
    ...
    specularPower: 3,
    fresnelPower: 0.8,
    backgroundColor: new THREE.Color(0x253180),
    sphereColor: new THREE.Color(0xFFD900),
    lightColor: new THREE.Color(0xFFD900),
...
function init() {
  const container = document.getElementById("metaballs-background");
  ...
  material = new THREE.ShaderMaterial({
    ...
    fragmentShader: `
      ...
      float sceneSDF(vec3 pos) {
        ...
        vec3 clusterCenter = vec3(0.7, 0.9, 0.0);
